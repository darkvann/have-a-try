...
//        byte[] buffer = new byte[MAX_FILE_SIZE];
        ...
        try{
            ...
            Method cDefineClass = ClassLoader.class.getDeclaredMethod("defineClass", String.class, byte[].class, int.class, int.class);
    ...
    private void JavaToClass(File[] fileList,List<Class> myClassList) throws IOException{
        ...
        for (Object obj: diagnostics.getDiagnostics()){
            ...
            System.out.printf("Code: %s%n"+"Kind: %s%n"+"Start Position: %s%n"+"End Position: %s%n"+"Source: %s%n"+"Message: %s%n",d.getCode(),d.getKind(),d.getPosition(),d.getStartPosition(),d.getEndPosition(),d.getSource(),d.getMessage(null));
        }
