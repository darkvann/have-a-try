...
<body>
    ...
    <div id="buttonContainer" style="display: flex;flex-direction: row;width: 100vw;height: 100px;align-items: center;">
        ...
        <div id="drawBtn" onclick="DrawRelationChat(classInfo)" style="border: solid black 1px;border-radius: 3px;height: 20px;margin-left: 50px;font-size: smaller;background-color: #eeeeee;cursor: pointer;user-select: none;padding-left: 3px;padding-right: 3px;">
            绘制类关系示意图
        </div>
    </div>
    <h3><%=classInfo%></h3>
